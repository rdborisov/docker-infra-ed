  ...
  - в директории sh содержится файл docker-install.sh, используемый мною для установки docker на виртуальную машину
  ...
  ```
  docker compose downы
  ```

Отчет со скриншотами приложен в pdf файле "Скриншоты"
